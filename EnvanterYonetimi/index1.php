			...
			<div class="row justify-content-center me-5 pe-4">
				...
				<div class="col-12 my-2 text-center">
						<div class="row ">
									...
									<input class="col-sm-6  firstname" type="text" required="" name="urun_Adi" placeholder="Envanter Adını Giriniz...">
						</div>			
				</div>
				<div class="col-12 my-2 text-center">
						<div class="row">
      ...
      <div class="row text-center justify-content-center">
        <table  class="content-table"  >
          ...
          <tr class="fw-bold text-white bg-dark">
            ...
            <th style="font-family: cursive;">Envanter Adı</th>
            <th style="font-family: cursive;">Envanter Kodu</th>
            <th style="font-family: cursive;">Kayıt Zamanı</th>
          ...
          <tr>
            ...
            <td align="center"><a href="duzenle1.php?urun_id=<?php echo $uruncek['urun_id'] ?>"><button class="fw-bold  rounded-2 shadow-lg  btn btn-light">Düzenle</button></td></a>
